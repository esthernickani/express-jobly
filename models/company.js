...
const { sqlForPartialUpdate, createSqlQueryForCompany, getErrorMessage } = require("../helpers/sql");
...
class Company {
  ...
  /** Find all companies with filter if added.
   *
   * Returns [{ handle, name, description, numEmployees, logoUrl }, ...]
   * throw error if no company found with filter
   * */
